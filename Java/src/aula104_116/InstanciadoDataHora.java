...
public class InstanciadoDataHora {
    public static void main(String[] args) {
        ...
        Instant d07 = Instant.parse("2022-07-20T11:30:26-03:00");

        LocalDate d08 = LocalDate.parse("20/07/2022", fmt1);
        LocalDateTime d09 = LocalDateTime.parse("20/07/2022 01:30", DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm"));
        LocalDate d10 = LocalDate.of(2024,7,14) ;
        LocalDateTime d11 = LocalDateTime.of(2024,7,14,1,30) ;
